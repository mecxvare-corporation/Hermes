...
namespace IdentityProvider.Infrastructure.Database
{
    public class IdentityDbContextInitializer
    {
        ...
        public IdentityDbContextInitializer(ILogger<IdentityDbContext> logger, IdentityDbContext context, ConfigurationDbContext configurationDbContext, PersistedGrantDbContext persistedGrantDbContext)
        {
            _logger = logger;
            _context = context;
